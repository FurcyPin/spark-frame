...
def schema_from_simple_string(schema_string: str):
    ...
    Raises an AssertionError if no SparkContext has been instantiated first.
...
def schema_to_simple_string(schema: DataType) -> str:
    ...
    This method is equivalent to calling `schema.simpleString()` directly.
